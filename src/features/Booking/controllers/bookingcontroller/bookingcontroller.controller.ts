...
export class BookingController {
  ...
  async getAvailableTimeSlots(
    ...
    try {
      ...
      return await this.bookingServiceService.getAvailableTimeSlots(
        bookingDate,
        serviceId,
      );
    } catch (e) {
  ...
  async getAllBookingsByUserId(@Param('userId') userId: string) {
    ...
    try {
      const bookings =
        await this.bookingServiceService.getBookingByUserId(userId);
      console.log(
        'Found bookings:',
  ...
  async assignEmployee(
    ...
    @Body() data: AssignEmployeeDto,
  ) {
    try {
      return await this.bookingServiceService.assignEmployee(
        bookingId,
  ...
  async getEmployeeBookings(@Param('employeeId') employeeId: string) {
    try {
      ...
      const bookings =
        await this.bookingServiceService.getEmployeeBookings(employeeId);
  ...
  async employeeupdateBooking(
    @Param('id') id: string,
    @Body() data: UpdateBookingDto,
  ) {
    try {
      return await this.bookingServiceService.EmployeeupdateBookingStatus(
        id,
        data,
      );
    } catch (e) {
  ...
  async rescheduleBooking(
    @Param('id') id: string,
    @Body() data: { date: string; timeSlot: string; reason?: string },
  ) {
    try {
      return await this.bookingServiceService.rescheduleBooking(
        id,
        data.date,
        data.timeSlot,
        data.reason,
  ...
  async resolveFlag(
    ...
    const flagResolved = await this.bookingServiceService.resolveFlag(
      employeeId,
      flagIndex,
      dto,
    );
